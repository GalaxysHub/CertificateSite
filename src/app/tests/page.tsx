...
// Language test data - in a real app this would come from an API
const sampleTests = [
  {
    id: 1,
    ...
    enrolledCount: 3241,
    featured: true,
    skills: ['Basic Grammar', 'Vocabulary', 'Present Tense', 'Articles'],
    instructor: 'Native Speaker Team',
  ...
  },
  {
    ...
    enrolledCount: 2876,
    featured: true,
    skills: ['Conditionals', 'Passive Voice', 'Phrasal Verbs', 'Subjunctive'],
    instructor: 'Cambridge Certified',
  ...
  },
  {
    ...
    enrolledCount: 1823,
    featured: false,
    skills: ['Gramática Básica', 'Ser/Estar', 'Presente', 'Artículos'],
    instructor: 'Profesores Nativos',
  ...
  },
  {
    ...
    enrolledCount: 1524,
    featured: false,
    skills: ['Grammaire de Base', 'Être/Avoir', 'Présent', 'Articles'],
    instructor: 'Équipe Francophone',
  ...
  },
  {
    ...
    enrolledCount: 987,
    featured: false,
    skills: ['Grundgrammatik', 'Sein/Haben', 'Präsens', 'Artikel'],
    instructor: 'Deutsche Muttersprachler',
  ...
  },
  {
    ...
    enrolledCount: 856,
    featured: false,
    skills: ['Grammatica Base', 'Essere/Avere', 'Presente', 'Articoli'],
    instructor: 'Team Madrelingua',
  ...
  },
  {
    ...
    enrolledCount: 1245,
    featured: true,
    skills: ['基础汉语', 'Pinyin', 'Basic Characters', 'HSK1 Vocabulary'],
    instructor: '中文老师团队',
  ...
  return (
    <Card className="h-full">
      ...
      <CardContent className="pt-0">
        ...
        <Button className="w-full mt-4 hover:ring-1 hover:ring-blue-300 hover:ring-offset-1 transition-all duration-200" asChild>
